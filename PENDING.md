...
- [x] **Admin web dashboard** — Status page at `http://PI_IP:7777` with bot uptime, RAM, CPU temp, message counts, active users, config, and build sessions. Basic auth, auto-refreshes every 30s. JSON API at `/api/stats`.
